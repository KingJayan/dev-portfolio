            ...
            {project && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            <X className="w-6 h-6 text-ink dark:text-gray-100" />
                        </button>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <div className="p-8 bg-secondary/20 flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-ink/10 relative">
                                <div className="relative w-full aspect-video bg-gray-200 border-4 border-white shadow-lg rotate-1 transform hover:rotate-0 transition-transform duration-500 overflow-hidden">
                                    ...
                                    />
                                    <div className="absolute inset-0 hidden flex items-center justify-center text-gray-400 font-marker text-2xl bg-gray-200 text-center p-4">
                                        NO PREVIEW IMAGE
                                    </div>
                                </div>
                                <div className="mt-8 flex gap-4">
                                    {project.githubUrl && (
                                        <a href={project.githubUrl} target="_blank" rel="noreferrer" className="flex items-center gap-2 font-hand text-lg hover:text-highlighter-blue transition-colors">
