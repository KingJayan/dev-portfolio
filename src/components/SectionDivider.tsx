export default function SectionDivider() {
    return (
        <div className="w-full overflow-hidden leading-[0] transform rotate-180 z-20 relative -mt-1">
            <svg
                className="w-full h-12 md:h-24 text-paper/95 dark:text-paper/45"
            ...
            <div className="absolute bottom-4 left-0 w-full border-b border-dashed border-pencil/20 dark:border-pencil/35" />
        </div>
    );
}
