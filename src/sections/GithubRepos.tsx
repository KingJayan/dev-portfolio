      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-10">
          {[...Array(6)].map((_, i) => (
            <div
              key={i}
              className={`w-full md:w-[calc(50%-20px)] lg:w-[calc(33.333%-28px)] h-48 bg-paper border-2 border-ink/10 shadow-paper animate-pulse ${
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-16 relative">
        ...
        <p className="font-hand text-xl text-pencil mt-4 rotate-[-1deg]">
                  ...
                  <span className="flex items-center gap-1.5">
                    <span
                      className={`w-3 h-3 rounded-full ${
                        LANGUAGE_COLORS[repo.language] ?? 'bg-pencil'
                      }`}
                    />
                    {repo.language}
                  </span>
